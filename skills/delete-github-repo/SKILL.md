...
description: >-
  ...
  包括任何涉及"删掉仓库"、"删除repo"、"清掉项目"、"把xxx仓库删了"、"批量删仓库"、"清理GitHub"、
...
'{{range .}}{{tablerow (printf "%s/%s" .owner.login .name) (printfsdescriptionate 40) (ternary "FORK" " .)agoAt)}}{{end}}'
```
...
| 2 | MAX208V/MAX208V.github.io  | 个人主页               | SOURCE  | 8个月前    |
```
...
Claude：✅ [1/3] MAX208V/test-a → 成功
        ✅ [2/3] MAX208V/test-b → 成功
